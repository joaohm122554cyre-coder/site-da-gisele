            ...
            return (
              <button
                ...
                style={{
                  ...
                  filter: isActive ? 'none' : 'blur(1.5px) brightness(0.72) saturate(0.9)',
                  boxShadow: isActive
                    ? '0 34px 60px -16px rgba(79,127,214,0.55), 0 14px 26px -10px rgba(0,0,0,0.55), 0 0 0 1px rgba(79,127,214,0.45)'
