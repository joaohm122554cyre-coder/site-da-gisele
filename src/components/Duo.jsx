...
function NamePill({ side, name, role }) {
  return (
    <div
      className={`absolute bottom-3 rounded-xl border border-[#f4eef7]/15 bg-[#14122a]/55 px-3 py-2 backdrop-blur-md md:bottom-6 md:px-4 md:py-3 ${
        side === 'left' ? 'left-3 md:left-6' : 'right-3 text-right md:right-6'
      }`}
    >
      <p className="font-display text-sm text-[#f4eef7] md:text-lg">{name}</p>
      <p className="mt-0.5 text-[9px] uppercase tracking-[0.25em] text-[#f4eef7]/60 md:text-[10px]">{role}</p>
    </div>
  )
}
...
function HeroPhoto() {
  ...
  return (
    <Reveal>
      <div
        ref={ref}
        className="relative aspect-[3/2] overflow-hidden rounded-2xl shadow-[0_0_0_1px_rgba(244,238,247,0.1),0_40px_120px_-40px_rgba(217,84,209,0.4)]"
      >
        <motion.img
          src={fotoRoxo}
...
export default function Duo() {
  return (
    <section id="dupla" aria-labelledby="dupla-titulo" className="relative py-28 md:py-40">
      <div className="mx-auto max-w-6xl px-6 md:px-12">
        <Reveal className="mb-14 text-center md:mb-20">
          <span className="font-script text-4xl leading-none text-[#d954d1] md:text-5xl">Giselli &amp; Nicolas</span>
          <h2
            id="dupla-titulo"
            className="mt-3 font-display text-4xl leading-[1.1] text-[#f4eef7] sm:text-5xl md:text-6xl"
          >
            Dois corações,
            <br />
            <span className="italic text-[#d954d1]">um só louvor</span>
          </h2>
          <p className="mx-auto mt-6 max-w-xl font-serif text-xl italic leading-relaxed text-[#f4eef7]/70 md:text-2xl">
        ...
        <div className="mt-20 grid gap-12 md:mt-32 md:grid-cols-12 md:gap-16">
        ...
        <Reveal className="mb-12 mt-24 text-center md:mb-16 md:mt-40">
          ...
          <h3 className="mt-4 font-display text-3xl leading-[1.15] text-[#f4eef7] sm:text-4xl md:text-5xl">
        ...
        <Reveal className="mt-24 text-center md:mt-36">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            ...
            >
              Ouvir as músicas
              <FiArrowUpRight className="text-base transition-transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5" aria-hidden="true" />
            </a>
            <a
              href="#videos"
